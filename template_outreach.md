# Template de outreach — Saldoar

## Asunto (subject line)

**ES:** `Saldoar - interés en integración API de pagos en {País/Región}`
**EN:** `Saldoar - interested in integrating your payments API in {Country/Region}`
...
```
Asunto: Saldoar - interés en integración API de pagos en {País/Región}
...
En Saldoar somos crypto-friendly: valoramos cripto y stablecoins como moneda base de balance, lo que nos da flexibilidad para integrarnos con proveedores que operen en FIAT, cripto o ambos. Adicionalmente, ya contamos con un proceso de KYC biométrico vía Veriff.

Me encantaría coordinar una llamada de 20-30 minutos para contarles nuestro caso y entender si su producto encaja. ¿Tienen disponibilidad esta semana o la próxima?

Saludos,
Leonardo Mansilla
Product Manager - Saldoar
emanuel@saldoar.com
```
...
```
Subject: Saldoar - interested in integrating your payments API in {Country/Region}
...
At Saldoar we are crypto-friendly: we value crypto and stablecoins as a base balance currency, which gives us flexibility to integrate with providers operating in FIAT, crypto, or both. We also already have a biometric KYC process in place via Veriff.

I'd love to set up a 20-30 minute call to share our use case and see if your product is a fit. Would you have availability this week or next?
